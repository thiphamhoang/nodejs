...
<div class="uploader">
    <div class="flex">
        <div class="text-center">
            <button class="btn btn-inverse close-uploader"><i class="icon-backward icon-white"></i> Quay lại</button>
        </div>
        <div class="space10"></div>
        <div class="tabbable upload-tabbable"> <!-- Only required for left/right tabs -->
            <div class="container1">
            <ul class="nav nav-tabs">
                <li class="active"><a href="#baseUpload" data-toggle="tab">Đăng ảnh từ máy</a></li>
                <?php if($config['url_upload']){ ?>
                <li><a href="#urlUpload" data-toggle="tab">Tải ảnh từ URL</a></li>
                <?php } ?>
            </ul>
                ...
                <div class="tab-pane active" id="baseUpload">
                    ...
                    <form id="fileupload" action="" method="POST" enctype="multipart/form-data">
                        <div class="container2">
                            ...
                            <div class="upload-help">Hướng dẫn</div>
                        </div>
                    </form>
