const BrandRequireModel = require('../BrandModel');

const  {multipleMongooseToObject, mongooseToObject} = require('../../../../util/mongoose');
const deleteUtil =  require('../../../../util/deleteRecursive');
const errorUtil =  require('../../../../util/errorNoti');
const folder_module = 'brand';
const module_name = 'Thương hiệu';
...
const permiView = 'brand_crm_view';
const permiEdit = 'brand_crm_edit';
