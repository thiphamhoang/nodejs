const BrandRequireModel = require('../GroupOfCustomerModel');

const  {multipleMongooseToObject, mongooseToObject} = require('../../../../util/mongoose');
const deleteUtil =  require('../../../../util/deleteRecursive');
const errorUtil =  require('../../../../util/errorNoti');
const folder_module = 'groupOfCustomer';
const module_name = 'Nhóm khách hàng';
...
const permiView = 'groupOfCustomer_crm_view';
const permiEdit = 'groupOfCustomer_crm_edit';
const layout = 'mainCrm';
const collection = 'GroupOfCustomer';
