const BrandRequireModel = require('../BranchModel');

const  {multipleMongooseToObject, mongooseToObject} = require('../../../../util/mongoose');
const deleteUtil =  require('../../../../util/deleteRecursive');
const folder_module = 'branch';
const module_name = 'Chi nhánh';
...
const permiView = 'branch_crm_view';
const permiEdit = 'branch_crm_edit';
