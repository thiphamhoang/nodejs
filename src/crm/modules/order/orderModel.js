...
function createCon(DBname,collection) {
    ...
    const ModSchema = new Schema({
        ...
        salesChannelId: {type:  mongoose.Schema.Types.ObjectId,  default: null}, // nkenhban
       
        paymentMethodId:  'string', // phuong thuc thanh toan
        customer: {
            customerId: {type:  mongoose.Schema.Types.ObjectId,  default: null}, // nkenhban
        ...
        note: 'string', //ghi chu
        delivery: {
            returnDate: {type: 'Date', role: null}, // thoi gian tao
            cod: {type: 'Number',default: 0}, // thoi gian 
            partnerId: 'string', // nguoi tao
